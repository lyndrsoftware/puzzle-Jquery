...
var Game = {
	...
	displayMessage: function()
	{
		...
		}).find(".remodal-body").html("<img class='heart d-none' src='logoH.png' /><h1>Congratulation</h1><strong class='h2'>Thanks for playing</strong><h4>Designed and coded by <strong>@lynnocheu</strong></h4><div><button type='button' class='btn btn-danger' onclick='Game.Start();'>Play again</button></div>");
